        ...
        <View style={tailwind`bg-tertiary h-full flex`}>
            ...
            <View style={tailwind`bg-white flex-row items-center justify-center mx-4 my-4 shadow-lg rounded-xl`}>
                ...
                <View style={tailwind`flex-row justify-center items-center py-2`}>
                    <TouchableOpacity style={tailwind`py-2 border-2 border-gray-100 px-4 w-20 items-center`}>
                        <Text style={tailwind`text-sm text-secondary`}>Edit</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={tailwind`py-2 border-2 border-red-600 px-4 bg-red-600 w-20 items-center`}>
